...
messages['th'] = {
    ...
    'permissionerror-title': u'เกิดข้อผิดพลาดในการเข้าถึงหน้า',
    'permissionerror-body': u'''คุณไม่สามารถเข้าหน้านี้ได้ เนื่องจากหน้านี้จะสามารถเข้าถึงได้จากผู้ใช้ที่ได้รับสิทธิให้เข้าถึงเท่านั้น
