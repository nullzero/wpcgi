...
messages['en'] = {
    'dykchecker': u'DYKChecker',
    'dykchecker-title': u'DYKChecker',
    'dykchecker-description': u'a tool to check whether the given article passes the minimum requirement of DYK Article in Thai Wikipedia',
    'dykchecker-description-content': (
u'''เครื่องมือนี้มีไว้เพื่อตรวจสอบบทความต่าง ๆ ที่ได้รับเสนอชื่อให้ขึ้นหน้าแรกของวิกิพีเดียในหัวข้อ "[บทความรู้ไหมว่า](https://th.wikipedia.org/wiki/วิกิพีเดีย:รู้ไหมว่า)"
ว่าผ่านเกณฑ์ขั้นเบื้องต้นหรือไม่
...
''', 'markdown'),
    ...
    'dykchecker-page-not-found': u'Page not found',

    'dykchecker-revision-info': u'Revision information',
    'dykchecker-revision-info-value': u'The latest revision is {0} from page {1} edited by {2} at {3} (UTC)',

    'dykchecker-inlineref': u'Citations',
    'dykchecker-inlineref-value': u'There are {0} inline citations',
    'dykchecker-inlineref-desc': u'The message shown on DYK Article section must have at least one inline citations',

    'dykchecker-length': u'Length',
    'dykchecker-length-value': u'The latest revision has {0} characters',
    'dykchecker-length-desc': u'DYK Article must has length of {0} characters (only prose)',

    'dykchecker-creation': u'Article creation',
    'dykchecker-creation-value': u'This article is created by {2} at {1} ({3} ago - revision {0})',
    'dykchecker-creation-new-desc': u'DYK Article must be created in {0} days ago (except the article has been improved significantly)',
    'dykchecker-creation-desc': u'',

    'dykchecker-old-revision': u'Old revision',
    'dykchecker-old-revision-value': u'Revision {0}, the old revision at {1} UTC ({2} days ago) '
                                     u'has length of {3} characters. Currently the article\'s length is increasing by {4} times',
    'dykchecker-old-revision-desc': u'ความยาวความเรียงต้องเพิ่มขึ้นอย่างน้อย {0} เท่า ภายในเวลา {1} วัน '
                                    u'ยกเว้นเป็นบทความสร้างใหม่<br/>'
                                    u'หมายเหตุ: หากจำนวนเนื้อหาที่เพิ่มติดลบ หมายความว่ามีเนื้อหาน้อยกว่าเดิม',
    'dykchecker-old-revision-not-exist': u'ไม่พบรุ่นเก่าภายในเวลา {0} วัน',
