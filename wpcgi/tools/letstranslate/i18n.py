...
messages['th'] = {
    ...
    'letstranslate-confirm-length': u'ความยาว:',
    'letstranslate-confirm-id': u'ลำดับที่การแปล:',
    ...
    'error-letstranslate-id-not-found': u'ไม่พบรายการที่เรียก',
    'error-letstranslate-mode': u'URL ที่คุณกำลังเข้าไม่ถูกต้อง',
